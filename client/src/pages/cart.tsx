...
import { removeItem, increaseQuantity, decreaseQuantity } from "../reducers/cartSlice";
...
const Cart = () => {
    ...
    useEffect(() => {
        ...
        cartItems.forEach((item) => {
            total = total + (item.dollar_price * item.quantity)
        ...
        <PageTransition>
            {cartItems.length ? (
                            ...
                            <div className={shippingState || paymentState ? "half cart-container" : "cart-container"}>
                                    ...
                                    {cartItems.map((item, index) => (
                                        <div className="item" key={index}>
                                            ...
                                            <div className="detail">
                                                ...
                                                <div className="right">
                                                    <button onClick={() => { dispatch(removeItem(item)); displayPopup('Item removed from cart') }}>
                                ...
                                <div className="checkout-section">
                                    ...
                                    <div className="price-summary">
                                        <p>Products in cart: <span>{cartItems.length} items</span></p>
                                        <p>Shipping: <span>$2.50</span></p>
                                        <p>Total: <span>${total.toFixed(2)}</span></p>
                                        <p>Grand Total: <span>${(total + 2.5).toFixed(2)}</span></p>
                                    </div>
                                </div>
                            </div>
                        }
                ...
                <div className="empty-cart">
                    <p>No item in cart</p>
                    <Link to='/marketplace'>Go back to shopping</Link>
                </div>
            )}
